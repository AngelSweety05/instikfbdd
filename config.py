...
API_ID = os.environ.get("API_ID", "129369")

API_HASH = os.environ.get("API_HASH", "7e24008e8ec39d618497b")

BOT_TOKEN = os.environ.get("BOT_TOKEN", "6396911:AAFJpaHVGsuPys-mSocXemUY") 

FORCE_SUB = os.environ.get("FORCE_SUB", "-10273") 
...
TEL_USERNAME = os.environ.get("TEL_USERNAME", "LazyDeveloper")
TEL_NAME = os.environ.get("TEL_NAME", "𓆩ཫ❤• LazyDeveloper •❤ཀ𓆪")
